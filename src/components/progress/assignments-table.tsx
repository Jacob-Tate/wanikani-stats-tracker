              ...
              >
                ...
                <td className="py-3 px-4">
                  <div className="flex items-center gap-2">
                    <span className="text-ink-100 dark:text-paper-100">{item.meaning}</span>
                    {item.hidden && (
                      <span className="text-xs px-1.5 py-0.5 rounded bg-ink-400/10 dark:bg-paper-400/10 text-ink-500 dark:text-paper-400 border border-ink-400/20 dark:border-paper-400/20">
                        Hidden
                      </span>
                    )}
                  </div>
